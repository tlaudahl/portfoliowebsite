            ...
            <p id='about'>
                ...
                {!hidden &&
                    <>
                        ...
                        <span className='moreLess' onClick={() => setHidden(!hidden)}><br />Less...</span>
                    </>}
